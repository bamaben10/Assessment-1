...
const analysisOfRequirements = "This is what needs to be done to create the project." 
const design = "This is the big picture view of the code itselfe."
const implementation = "This involves writing the code and making sure it runs."
const testingAndIntegration = "Tests are run to make suree code is doing what it needs to do."
const maintain = "This involoves updating and making sure the code gets to the customer how it is expected too.  This includes debugging things along the way."